...
.. math::
   V(r) = \frac{Z_{eff}^2}{r}e^{-r/\lambda_e},

Where :math:`r` is the distance between ions, :math:`Z_{eff}` is the effective ion charge or the effective ionization, and :math:`\lambda_e` is the electron screening length.
