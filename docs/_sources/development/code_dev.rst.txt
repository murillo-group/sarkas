...
After editing the file locally, build the docs as described in :ref:`these instructions <dev_docs>` and then you can submit 
...
you follow :ref:`this guide <dev-contributing>` that we have prepared for you.
