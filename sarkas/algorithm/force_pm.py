...
def force_optimized_green_function(MGrid, aliases, BoxLv, p, constants):
    ...
    mx_max = aliases[0]  # params.pppm.mx_max
    my_max = aliases[1]  # params.pppm.my_max
    mz_max = aliases[2]  # params.pppm.mz_max
    Mx = MGrid[0]  # params.pppm.Mx
    My = MGrid[1]  # params.pppm.My
    Mz = MGrid[2]  # params.pppm.Mz
